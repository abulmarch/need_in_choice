            ...
            SliverAppBar(
              ...
              const SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: SearchFormField(hintText: 'Find vehicle, furniture and more',),
                  ),
                ) : const SizedBox(),
              floating: true,
              pinned: true,
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Modern Contrper',
                                style: Theme.of(context).textTheme.titleSmall?.copyWith(color: kFadedBlack,fontWeight: FontWeight.w600,fontSize: 15),//TextStyle(color: kFadedBlack),
                                  ...
                                  RichText(
                                    text: const TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        TextSpan(
                                          text: '19950/-',
                                          style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: kFadedBlack)
                                        )
                                      ]
                                    ),
                                  ),
                ...
                child: Column(
                  ...
                  children: [                              
                    ...
                    RichText(
                      text: TextSpan(
                        text: 'Buy &',
                        style: Theme.of(context).textTheme.headlineSmall!.copyWith(color: const Color(0xFF484848)),
                        children: <TextSpan>[
                          TextSpan(
                            text: 'Sell \nAnything Now', 
                            // style: TextStyle(),
                ...
                children: [
                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        const TextSpan(text: 'Details',style: TextStyle(color: Color(0xFF1C8FFB)),),
          ...
          Row(
            ...
            children: [
              Text(
                ...
                style: Theme.of(context).textTheme.titleMedium?.copyWith(fontSize: 17,fontWeight: FontWeight.bold,color: const Color(0xFF484848)),
              ),
              TextButton(
                style: ButtonStyle(
            ...
            child: LayoutBuilder(
              builder: (BuildContext ctx, BoxConstraints bConst) {
                return Padding(
                  ...
                  child: ScrollingCategory(selectedCategory: 0/*_selectedCategory*/, size: bConst.maxHeight),
                );
              }
            ),
          ),
          DashedLineGenerator(width: constraints.maxWidth-30,)
        ],
      ),
    );
  }
