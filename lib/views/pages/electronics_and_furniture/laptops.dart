...
class LaptopsAndComputerScreen extends StatelessWidget {
  const LaptopsAndComputerScreen({super.key});
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        itemCount: electronics4sale.length,
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: electronics4sale[index]['cat_name']!
                                              .toLowerCase() ==
                                          'laptops & computers'
                                ...
                                child: Image.asset(
                                  electronics4sale[index]['cat_img']!,
                                  height: height * 0.07,
                                  width: width * 0.1,
                                ),
                              ),
                              Text(
                                electronics4sale[index]['cat_name']!
                                    .toLowerCase(),
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Stack(
                                  ...
                                  children: [
                                    DashedLineGenerator(
                                      width: electronics4sale[0]['cat_name']!
                                              .length *
                                          width *
                                          0.035,
                                      color: kDottedBorder,
