...
const kUserImage = 'image';
const kUserCreatedAt = 'created_at';
const kUserIsOnline = 'is_online';
const kUserLastActive = 'last_active';
const kUserPushToken = 'push_token';
